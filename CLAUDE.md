...
```mermaid
graph TD
  606a2f9e["ERC-721 NFT"]
  d1e4ec9f["Frontend"]
  bb9534d2["Wallet Auth"]
  606a2f9e --> d1e4ec9f
  d1e4ec9f --> bb9534d2
```
...
1. **ERC-721 NFT** (`erc721-stylus`) — see `.nskills/components/erc721-stylus--606a2f9e.md`
2. **Frontend** (`frontend-scaffold`) — see `.nskills/components/frontend-scaffold--d1e4ec9f.md`
3. **Wallet Auth** (`wallet-auth`) — see `.nskills/components/wallet-auth--bb9534d2.md`
...
- [ERC-721 NFT](.nskills/components/erc721-stylus--606a2f9e.md)
- [Frontend](.nskills/components/frontend-scaffold--d1e4ec9f.md)
- [Wallet Auth](.nskills/components/wallet-auth--bb9534d2.md)
